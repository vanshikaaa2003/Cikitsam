...
public class gad_ques7 extends AppCompatActivity {
    Button next,prev;
    RadioGroup question4RadioGroup;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_gad_ques7);
        prev = findViewById(R.id.prev_6);
        next = findViewById(R.id.submitnext);
        question4RadioGroup =findViewById(R.id.gad_test_7);
        ...
        next.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                {
                    Toast.makeText(gad_ques7.this, "No Option Selected", Toast.LENGTH_SHORT).show();
                }
                else {
                    SharedPreferences sharedPreferences = getSharedPreferences("MyPrefs", Context.MODE_PRIVATE);
                    SharedPreferences.Editor editor = sharedPreferences.edit();
                    editor.putString("gad_7", selectedOption);
                    editor.apply();

                    Intent l = new Intent(gad_ques7.this, Result_gad.class);
                    startActivity(l);
                }
            }
