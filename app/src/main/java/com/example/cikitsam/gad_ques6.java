...
public class gad_ques6 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_gad_ques6);

        prev = findViewById(R.id.prev_5);
        next = findViewById(R.id.next_6);
        question4RadioGroup =findViewById(R.id.gad_test_6);
        ...
        next.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                {
                    Toast.makeText(gad_ques6.this, "No Option Selected", Toast.LENGTH_SHORT).show();
                }
                else {
                    SharedPreferences sharedPreferences = getSharedPreferences("MyPrefs", Context.MODE_PRIVATE);
                    SharedPreferences.Editor editor = sharedPreferences.edit();
                    editor.putString("gad_6", selectedOption);
                    editor.apply();

                    Intent l = new Intent(gad_ques6.this, gad_ques7.class);
                    startActivity(l);
                }
            }
