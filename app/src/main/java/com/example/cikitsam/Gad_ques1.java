...
public class Gad_ques1 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_gad_ques1);
        next = findViewById(R.id.next_1);
        question1RadioGroup = findViewById(R.id.gad_test_1);
        ...
        next.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                {
                    Toast.makeText(Gad_ques1.this, "No Option Selected", Toast.LENGTH_SHORT).show();
                }
                else
                {
                    SharedPreferences sharedPreferences = getSharedPreferences("MyPrefs", Context.MODE_PRIVATE);
                    SharedPreferences.Editor editor = sharedPreferences.edit();
                    editor.putString("gad_1", selectedOption);
                    editor.apply();

                    Intent s = new Intent(Gad_ques1.this,gad_ques2.class);
                    startActivity(s);
                }
            }
