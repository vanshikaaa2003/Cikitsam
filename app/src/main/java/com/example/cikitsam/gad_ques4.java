...
public class gad_ques4 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_gad_ques4);
        prev = findViewById(R.id.prev_3);
        next = findViewById(R.id.next_4);
        question4RadioGroup =findViewById(R.id.gad_test_4);
        ...
        next.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                {
                    Toast.makeText(gad_ques4.this, "No Option Selected", Toast.LENGTH_SHORT).show();
                }
                else {
                    SharedPreferences sharedPreferences = getSharedPreferences("MyPrefs", Context.MODE_PRIVATE);
                    SharedPreferences.Editor editor = sharedPreferences.edit();
                    editor.putString("gad_4", selectedOption);
                    editor.apply();

                    Intent l = new Intent(gad_ques4.this, gad_ques5.class);
                    startActivity(l);
                }
            }
